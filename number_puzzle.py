...
class NumberPuzzle(tk.Tk):
    def __init__(self):
        ...
        self.colors = ["#FF6666", "#FFB226", "#FFFF66", "#B2FF66", "#66FF66", "#66FFB2", "#66FFFF", "#66B2FF",
    ...
    def create_tiles(self):
        for i in range(4):
            ...
            for j in range(4):
                ...
                tile = tk.Button(self, text=number, font=("Arial", 20), width=4, height=2,
    ...
    def create_info_panel(self):
        ...
        self.click_count_label = tk.Label(self.info_frame, text="Total Clicks: 0", font=("Arial", 14))
    ...
    def update_click_count_label(self):
        self.click_count_label.config(text=f"Total Clicks: {self.t_clicks}")
    ...
    def key_press(self, event):
        ...
        if key == "Up" and blank_pos[0] > 0:
            self.swap_tiles(blank_pos, (blank_pos[0] - 1, blank_pos[1]))
        elif key == "Down" and blank_pos[0] < 3:
            self.swap_tiles(blank_pos, (blank_pos[0] + 1, blank_pos[1]))
        elif key == "Left" and blank_pos[1] > 0:
            self.swap_tiles(blank_pos, (blank_pos[0], blank_pos[1] - 1))
        elif key == "Right" and blank_pos[1] < 3:
            self.swap_tiles(blank_pos, (blank_pos[0], blank_pos[1] + 1))
        if self.check_win():
            elapsed_time = int(time.time() - self.start_time)
            messagebox.showinfo("Congrats!!", f"You have solved the puzzle in {elapsed_time}s and {self.t_clicks} moves.")
            self.reset_game()
